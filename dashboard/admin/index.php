<div class="container mt-3">
  <?php if (isset($_SESSION['pesan'])) : ?>
    ...
    <div class="card mb-3">
      <img src="assets/image/poster1.png" class="card-img-top" height="200">
    </div>

    <div class="card-body text-center" >        
          <h3 class="card-title font-weight-bold">SELAMAT DATANG DI HALAMAN MENU</h3>
          <p class="card-text ">Telp : (021) 222 333 444 | Email : nasikucingware@gmail.com</p>
      </div>
      <br>

    <h3 class="mb-3 font-weight-bold">Menu Makanan</h3>
    <div class="row">
      <div class="col-md-12" style="border-top: 5px dashed #ccc;">
      <br>
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-1">
                  ...
                  <?php else: ?>
                    <a href="index.php?tambah=<?= $data['id_masakan'] ?>" class="btn btn-primary btn-sm btn-block disabled">Order</a>
                  <?php endif; ?>
              </div>
            </div>
          </div>
    ...
    <h3 class="mb-3 font-weight-bold">Menu Minuman</h3>
    <div class="row">
      <div class="col-md-12" style="border-top: 5px dashed #ccc;">
      <br>
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-1">
                  ...
                  <?php else: ?>
                    <a href="index.php?tambah=<?= $data['id_masakan'] ?>" class="btn btn-primary btn-block disabled">Order</a>
                  <?php endif; ?>
              </div>
            </div>
          </div>
