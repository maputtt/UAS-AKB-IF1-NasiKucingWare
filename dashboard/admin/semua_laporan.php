      ...
      <div class="row">
        <div class="col-md-10 mx-auto mt-5">
          <div class="text-center">
            <h3>Laporan Keseluruhan Transaksi Penjualan</h3>
            <h5><img src="../assets/image/logonasikucingcircle.png" width="30">Nasi Kucing Ware</h5>
            <p>Contact : (021) 222 333 444 | Email : nasikucingware@gmail.com</p>
          </div>
          <div class="card">
            <div class="card-body">
